...
namespace X
{
	/// \brief Template class to manage pointers to objects of a class of the given type.
	///
	...
	/// X::CManager<CCamera> cameraManager;
	/// CCamera* pCamera = cameraManager.add("Camera1");
	/// \endcode

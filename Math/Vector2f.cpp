...
namespace X
{
	...
	{
		ThrowIfTrue(fScaler < 0.0000001f, "Given scalar of zero which creates a divide by zero.");
	...
	void CVector2f::rotateDegrees(float fDegrees)
	{
	...
	void CVector2f::rotateRadians(float fRadians)
	{
		fRadians *= -1.0f;
		float fOldX = x;
		float fOldY = y;

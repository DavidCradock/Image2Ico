...
namespace X
{
	...
	*/
	...
	CVector3f CMatrix::multiply(const CVector3f& v) const
	{
		CVector3f r;
	...
	CVector4f CMatrix::multiply(const CVector4f& v)
	{
		CVector4f r;
		...
		float fAspectRatio)
	{
		...
		ThrowIfTrue(fNearMinusFar == 0.0f, "Given near and far clipping plane distances invalid.");

...
namespace X
{
	...
	public:
		...
		void rotateDegrees(float fDegrees);

		/// \brief If this vector represents a position, rotate it clockwise by the given number of radians
		///
		/// \param fRadians The angle in radians in which to rotate this vector when it represents a position
		void rotateRadians(float fRadians);
